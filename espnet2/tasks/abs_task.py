...
class AbsTask(ABC):
    ...
    def build_chunk_iter_factory(
        ...
        if distributed:
            ...
            #   the each lengths, therefore the number of iteration counts are not
            #   always equal among processes and the iterations counts are limitted
            #   by the smallest iterations.
