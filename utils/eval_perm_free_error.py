...
def merge_results(results):
    ...
    logging.info("After merge, the result has " + str(len(intersec_keys)) + " utterances")
...
def get_parser():
    ...
    parser.add_argument("--num-spkrs", type=int, default=2, help="number of mixed speakers.")
    parser.add_argument(
        "results",
        type=str,
        nargs="+",
