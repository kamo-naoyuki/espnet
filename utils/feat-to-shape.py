...
def get_parser():
    parser = argparse.ArgumentParser(
        description="convert feature to its shape", formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
...
def main():
    ...
    for utt, mat in file_reader_helper(args.rspecifier, args.filetype, return_shape=preprocessing is None):
