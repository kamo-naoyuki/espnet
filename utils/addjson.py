...
def get_parser():
    ...
    parser.add_argument(
        "-i", "--is-input", default=True, type=strtobool, help="If true, add to input. If false, add to output",
    )
...
if __name__ == "__main__":
    ...
    jsonstring = json.dumps({"utts": new_dic}, indent=4, ensure_ascii=False, sort_keys=True, separators=(",", ": "),)
