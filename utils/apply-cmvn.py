...
def get_parser():
    ...
    parser.add_argument(
        ...
        default="mat",
        choices=["mat", "hdf5"],
        help="Specify the file format for the wspecifier. " '"mat" is the matrix format in kaldi',
    )

    parser.add_argument(
        "--norm-means", type=strtobool, default=True, help="Do variance normalization or not.",
    )
    parser.add_argument(
        "--norm-vars", type=strtobool, default=False, help="Do variance normalization or not.",
    )
    parser.add_argument("--reverse", type=strtobool, default=False, help="Do reverse mode or not")
    parser.add_argument(
        "--spk2utt",
        type=str,
    ...
    parser.add_argument(
        "--utt2spk",
        type=str,
        help="A text file of utterance to speaker map. " "(Don't give rspecifier format, such as " '"ark:utt2spk")',
    )
    ...
    parser.add_argument(
        "stats_rspecifier_or_rxfilename", help="Input stats. e.g. ark:stats.ark or stats.mat",
    )
...
def main():
    ...
    if ":" in args.stats_rspecifier_or_rxfilename:
        ...
        stats_dict = dict(file_reader_helper(args.stats_rspecifier_or_rxfilename, stats_filetype))
    else:
        is_rspcifier = False
