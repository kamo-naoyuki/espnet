...
def train(args):
    ...
    trainer.extend(extensions.PlotReport(["main/ppl", "validation/main/ppl"], "epoch", file_name="ppl.png"))
    ...
    if args.batchsize == 0:
        ...
        with torch.no_grad():
            for names in grouper(args.batchsize, keys, None):
                ...
                feats = [
                    np.fromiter(map(int, js[name]["output"][1]["tokenid"].split()), dtype=np.int64,) for name in names
                ]
