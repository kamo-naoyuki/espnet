...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        # prediction
        group.add_argument(
            "--dec-embed-dim", default=320, type=int, help="Number of decoder embeddings dimensions",
        )
        group.add_argument(
            "--dropout-rate-embed-decoder", default=0.0, type=float, help="Dropout rate for the decoder embeddings",
        )
        # general
        group.add_argument(
            "--rnnt_type",
        ...
        group.add_argument(
            "--rnnt-mode", default="rnnt", type=str, choices=["rnnt", "rnnt-att"], help="RNN-Transducing mode",
        )
        group.add_argument(
