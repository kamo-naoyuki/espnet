    ...
    def __init__(self, odim, args, initialW=None, initial_bias=None):
        ...
        with self.init_scope():
            ...
            self.output_layer = L.Linear(
                args.adim, odim, initialW=initialW(scale=stvd), initial_bias=initial_bias(scale=stvd),
            )
            self.embed = L.EmbedID(odim, args.adim, ignore_label=-1, initialW=chainer.initializers.Normal(scale=1.0),)
