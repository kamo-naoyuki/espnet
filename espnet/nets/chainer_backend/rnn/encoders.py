    ...
    def __init__(self, idim, elayers, cdim, hdim, subsample, dropout, typ="blstm"):
        ...
        with self.init_scope():
            for i in six.moves.range(elayers):
                ...
                setattr(self, "{}{:d}".format(rnn_label, i), rnn(1, inputdim, cdim, dropout))
...
class VGG2L(chainer.Chain):
    ...
    def __call__(self, xs, ilens):
        ...
        xs = F.swapaxes(xs.reshape(xs.shape[0], xs.shape[1], self.in_channel, xs.shape[2] // self.in_channel,), 1, 2,)
    ...
    def __init__(self, etype, idim, elayers, eunits, eprojs, subsample, dropout, in_channel=1):
        ...
        with self.init_scope():
            if etype.startswith("vgg"):
                ...
                if etype[-1] == "p":
                    self.enc = chainer.Sequential(RNNP(idim, elayers, eunits, eprojs, subsample, dropout, typ=typ))
