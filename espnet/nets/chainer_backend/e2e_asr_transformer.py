...
class E2E(ChainerASRInterface):
    ...
    def add_arguments(parser):
        ...
        group.add_argument(
            "--transformer-init", type=str, default="pytorch", help="how to initialize transformer parameters",
        )
        group.add_argument(
    ...
    def __init__(self, idim, odim, args, ignore_id=-1, flag_return=True):
        ...
        with self.init_scope():
            ...
            self.criterion = LabelSmoothingLoss(
                args.lsm_weight, len(args.char_list), args.transformer_length_normalized_loss,
            )
            if args.mtlalpha > 0.0:
                if args.ctc_type == "builtin":
                    ...
                    raise ValueError('ctc_type must be "builtin" or "warpctc": {}'.format(args.ctc_type))
            else:
                self.ctc = None
        self.dims = args.adim
        self.odim = odim
        ...
        for i in six.moves.range(maxlen):
            ...
            for hyp in hyps:
                ...
                if lpz is not None:
                    ...
                    local_scores = (1.0 - ctc_weight) * local_att_scores[:, local_best_ids] + ctc_weight * (
